...
export const AgentStateSchema = z.object({
  ...
  locationChoices: z.array(z.object({
    id: z.string(),
    label: z.string(),
    lat: z.number(),
    lng: z.number(),
    kind: z.enum(['field', 'plant', 'poi']).optional(),
  })).default([]),
  awaitingLocationChoice: z.enum(['origin', 'destination']).nullable().optional(),
...
export const AgentStateAnnotation = Annotation.Root({
  ...
  locationChoices: Annotation<Array<{ id: string; label: string; lat: number; lng: number; kind?: 'field' | 'plant' | 'poi' }>>(),
  awaitingLocationChoice: Annotation<'origin' | 'destination' | null | undefined>(),
  ...
  buttons: Annotation<Array<{ id: string; title: string }> | undefined>(),

...
import { FreightLocationsController, FreightMapPublicController, FreightMapPublicAnonController } from './freight-locations.controller';
import { FreightLocationsService } from './freight-locations.service';

@Module({
  imports: [DatabaseModule, CommonModule],
  controllers: [FreightLocationsController, FreightMapPublicController, FreightMapPublicAnonController],

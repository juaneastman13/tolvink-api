  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        tons: { type: 'number' },
        truckCount: { type: 'number', description: 'OBLIGATORIO: Cantidad de camiones que necesita el usuario.' },
        ...
        useOwnFleet: { type: 'boolean', description: 'OBLIGATORIO: true=flota propia (el sistema muestra listas de camiones y choferes), false=delega a la planta.' },

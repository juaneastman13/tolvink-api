-- CreateEnum
CREATE TYPE "TruckDocumentType" AS ENUM ('VTV_ITV', 'INSURANCE', 'TRANSPORT_LICENSE', 'GREEN_CARD', 'DRIVER_LICENSE', 'RUAT', 'SENASA', 'FUMIGATION', 'OTHER');

-- CreateEnum
CREATE TYPE "TruckExpenseType" AS ENUM ('FUEL', 'TOLL', 'MAINTENANCE', 'TIRE', 'INSURANCE', 'FINE', 'PARKING', 'MEAL', 'OTHER');
...
-- CreateIndex
CREATE INDEX "truck_documents_truck_id_company_id_idx" ON "truck_documents"("truck_id", "company_id");
CREATE INDEX "truck_documents_expires_at_idx" ON "truck_documents"("expires_at");

-- CreateIndex
CREATE INDEX "truck_expenses_truck_id_company_id_idx" ON "truck_expenses"("truck_id", "company_id");
CREATE INDEX "truck_expenses_date_idx" ON "truck_expenses"("date");
